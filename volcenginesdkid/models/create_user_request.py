...
class CreateUserRequest(object):
    ...
    def __init__(self, email=None, email_verified=None, family_name=None, given_name=None, middle_name=None, name=None, password=None, phone_number=None, phone_number_verified=None, preferred_username=None, user_metadata=None, user_pool_uid=None, _configuration=None):  # noqa: E501
