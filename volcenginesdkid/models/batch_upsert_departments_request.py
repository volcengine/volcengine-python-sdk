...
class BatchUpsertDepartmentsRequest(object):
    ...
    def departments(self):
        """Gets the departments of this BatchUpsertDepartmentsRequest.  # noqa: E501


        :return: The departments of this BatchUpsertDepartmentsRequest.  # noqa: E501
        :rtype: list[DepartmentForBatchUpsertDepartmentsInput]
        """
        return self._departments

    @departments.setter
    def departments(self, departments):
        """Sets the departments of this BatchUpsertDepartmentsRequest.


        :param departments: The departments of this BatchUpsertDepartmentsRequest.  # noqa: E501
        :type: list[DepartmentForBatchUpsertDepartmentsInput]
        """
    ...
    @property
    def source(self):
        """Gets the source of this BatchUpsertDepartmentsRequest.  # noqa: E501


        :return: The source of this BatchUpsertDepartmentsRequest.  # noqa: E501
        :rtype: str
        """
        return self._source
    ...
    def source(self, source):
        """Sets the source of this BatchUpsertDepartmentsRequest.


        :param source: The source of this BatchUpsertDepartmentsRequest.  # noqa: E501
        :type: str
        """
    ...
    def user_pool_uid(self):
        """Gets the user_pool_uid of this BatchUpsertDepartmentsRequest.  # noqa: E501


        :return: The user_pool_uid of this BatchUpsertDepartmentsRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def user_pool_uid(self, user_pool_uid):
        """Sets the user_pool_uid of this BatchUpsertDepartmentsRequest.


        :param user_pool_uid: The user_pool_uid of this BatchUpsertDepartmentsRequest.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BatchUpsertDepartmentsRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchUpsertDepartmentsRequest):
            return False
