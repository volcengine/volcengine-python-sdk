...
import pytz
import sys
from volcenginesdkcore.sign.meta_data import MetaData
from volcenginesdkcore.sign.request import Request
from volcenginesdkcore.sign.result import SignResult
from volcenginesdkcore.utils.util import Util
...
class SignerV4(object):
    ...
    def sign(request, credentials):
        ...
        signing_key = SignerV4.get_signing_secret_key_v4(credentials.sk, md.date, md.region, md.service)  # 没问题
    ...
    def hashed_canonical_request_v4(request, meta):
        ...
        request.headers['X-Content-Sha256'] = body_hash   # 没问题
