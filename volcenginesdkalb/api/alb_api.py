...
class ALBApi(object):
    ...
    def load_balancer_join_security_group(self, body, **kwargs):  # noqa: E501
        """load_balancer_join_security_group  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.load_balancer_join_security_group(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param LoadBalancerJoinSecurityGroupRequest body: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.load_balancer_join_security_group_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.load_balancer_join_security_group_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def load_balancer_join_security_group_with_http_info(self, body, **kwargs):  # noqa: E501
        """load_balancer_join_security_group  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.load_balancer_join_security_group_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method load_balancer_join_security_group" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `load_balancer_join_security_group`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/LoadBalancerJoinSecurityGroup/2020-04-01/alb/get/text_plain/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='LoadBalancerJoinSecurityGroupResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def load_balancer_leave_security_group(self, body, **kwargs):  # noqa: E501
        """load_balancer_leave_security_group  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.load_balancer_leave_security_group(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param LoadBalancerLeaveSecurityGroupRequest body: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.load_balancer_leave_security_group_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.load_balancer_leave_security_group_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def load_balancer_leave_security_group_with_http_info(self, body, **kwargs):  # noqa: E501
        """load_balancer_leave_security_group  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.load_balancer_leave_security_group_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method load_balancer_leave_security_group" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `load_balancer_leave_security_group`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/LoadBalancerLeaveSecurityGroup/2020-04-01/alb/get/text_plain/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='LoadBalancerLeaveSecurityGroupResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
