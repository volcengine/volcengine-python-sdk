...
class RuleForModifyRulesInput(object):
    ...
    def __init__(self, description=None, redirect_config=None, rule_action=None, rule_id=None, server_group_id=None, traffic_limit_enabled=None, traffic_limit_qps=None, _configuration=None):  # noqa: E501
