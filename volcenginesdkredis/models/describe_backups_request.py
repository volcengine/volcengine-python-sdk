...
class DescribeBackupsRequest(object):
    ...
    def __init__(self, backup_strategy_list=None, end_time=None, instance_id=None, page_number=None, page_size=None, start_time=None, _configuration=None):  # noqa: E501
