...
class IncreaseDBInstanceNodeNumberRequest(object):
    ...
    def __init__(self, apply_immediately=None, client_token=None, configure_new_nodes=None, create_backup=None, instance_id=None, nodes_number_to_increase=None, _configuration=None):  # noqa: E501
