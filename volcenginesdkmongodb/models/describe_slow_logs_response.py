...
class DescribeSlowLogsResponse(object):
    ...
    swagger_types = {
        'context': 'str',
        'datas': 'list[DataForDescribeSlowLogsOutput]',
        'list_over': 'bool',
        'total': 'int'
    }
    ...
    @property
    def datas(self):
        """Gets the datas of this DescribeSlowLogsResponse.  # noqa: E501


        :return: The datas of this DescribeSlowLogsResponse.  # noqa: E501
        :rtype: list[DataForDescribeSlowLogsOutput]
        """
        return self._datas

    @datas.setter
    def datas(self, datas):
        """Sets the datas of this DescribeSlowLogsResponse.


        :param datas: The datas of this DescribeSlowLogsResponse.  # noqa: E501
        :type: list[DataForDescribeSlowLogsOutput]
        """
