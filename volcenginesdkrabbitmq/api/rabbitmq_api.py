...
class RABBITMQApi(object):
    ...
    def associate_allow_list_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/AssociateAllowList/2022-01-01/rabbitmq/post/application_json/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def create_allow_list_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/CreateAllowList/2022-01-01/rabbitmq/post/application_json/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_allow_list_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/DeleteAllowList/2022-01-01/rabbitmq/post/application_json/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def describe_allow_list_detail_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/DescribeAllowListDetail/2022-01-01/rabbitmq/post/application_json/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def describe_allow_lists_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/DescribeAllowLists/2022-01-01/rabbitmq/post/application_json/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def describe_instance_configs(self, body, **kwargs):  # noqa: E501
        """describe_instance_configs  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.describe_instance_configs(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param DescribeInstanceConfigsRequest body: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.describe_instance_configs_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.describe_instance_configs_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def describe_instance_configs_with_http_info(self, body, **kwargs):  # noqa: E501
        """describe_instance_configs  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.describe_instance_configs_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method describe_instance_configs" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `describe_instance_configs`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/DescribeInstanceConfigs/2022-01-01/rabbitmq/post/application_json/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='DescribeInstanceConfigsResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def disassociate_allow_list_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/DisassociateAllowList/2022-01-01/rabbitmq/post/application_json/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def modify_allow_list_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/ModifyAllowList/2022-01-01/rabbitmq/post/application_json/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
