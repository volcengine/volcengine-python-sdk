...
class DescribeAllowListDetailResponse(object):
    ...
    def __init__(self, allow_list=None, allow_list_desc=None, allow_list_id=None, allow_list_name=None, associated_instances=None, _configuration=None):  # noqa: E501
