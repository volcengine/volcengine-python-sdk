...
class TransitRouterRouteTablePropagationForDescribeTransitRouterRouteTablePropagationsOutput(object, ):
    ...
    swagger_types = {'creation_time': 'str', 'status': 'str', 'transit_router_attachment_id': 'str', 'transit_router_route_table_id': 'str'}
    attribute_map = {'creation_time': 'CreationTime', 'status': 'Status', 'transit_router_attachment_id': 'TransitRouterAttachmentId', 'transit_router_route_table_id': 'TransitRouterRouteTableId'}

    def __init__(self, creation_time=None, status=None, transit_router_attachment_id=None, transit_router_route_table_id=None, _configuration=None):
...
class TransitRouterTrafficQosQueueEntryForDescribeTransitRouterTrafficQosQueueEntriesOutput(object, ):
    ...
    swagger_types = {'bandwidth_percent': 'int', 'creation_time': 'str', 'description': 'str', 'dscps': 'list[int]', 'is_default': 'bool', 'status': 'str', 'transit_router_traffic_qos_queue_entry_id': 'str', 'transit_router_traffic_qos_queue_entry_name': 'str', 'transit_router_traffic_qos_queue_policy_id': 'str', 'update_time': 'str'}
    attribute_map = {'bandwidth_percent': 'BandwidthPercent', 'creation_time': 'CreationTime', 'description': 'Description', 'dscps': 'Dscps', 'is_default': 'IsDefault', 'status': 'Status', 'transit_router_traffic_qos_queue_entry_id': 'TransitRouterTrafficQosQueueEntryId', 'transit_router_traffic_qos_queue_entry_name': 'TransitRouterTrafficQosQueueEntryName', 'transit_router_traffic_qos_queue_policy_id': 'TransitRouterTrafficQosQueuePolicyId', 'update_time': 'UpdateTime'}

    def __init__(self, bandwidth_percent=None, creation_time=None, description=None, dscps=None, is_default=None, status=None, transit_router_traffic_qos_queue_entry_id=None, transit_router_traffic_qos_queue_entry_name=None, transit_router_traffic_qos_queue_policy_id=None, update_time=None, _configuration=None):
