...
class TransitRouterMulticastDomainAssociationForDescribeTransitRouterMulticastDomainAssociationsOutput(object, ):
    ...
    swagger_types = {'creation_time': 'str', 'resource_id': 'str', 'resource_type': 'str', 'status': 'str', 'subnet_id': 'str', 'transit_router_attachment_id': 'str', 'transit_router_multicast_domain_id': 'str', 'update_time': 'str'}
    attribute_map = {'creation_time': 'CreationTime', 'resource_id': 'ResourceId', 'resource_type': 'ResourceType', 'status': 'Status', 'subnet_id': 'SubnetId', 'transit_router_attachment_id': 'TransitRouterAttachmentId', 'transit_router_multicast_domain_id': 'TransitRouterMulticastDomainId', 'update_time': 'UpdateTime'}

    def __init__(self, creation_time=None, resource_id=None, resource_type=None, status=None, subnet_id=None, transit_router_attachment_id=None, transit_router_multicast_domain_id=None, update_time=None, _configuration=None):
        'TransitRouterMulticastDomainAssociationForDescribeTransitRouterMulticastDomainAssociationsOutput - a model defined in Swagger'
    ...
    def creation_time(self):
        """Gets the creation_time of this TransitRouterMulticastDomainAssociationForDescribeTransitRouterMulticastDomainAssociationsOutput.  # noqa: E501
    ...
    def creation_time(self, creation_time):
        """Sets the creation_time of this TransitRouterMulticastDomainAssociationForDescribeTransitRouterMulticastDomainAssociationsOutput.
    ...
    def resource_id(self):
        """Gets the resource_id of this TransitRouterMulticastDomainAssociationForDescribeTransitRouterMulticastDomainAssociationsOutput.  # noqa: E501
    ...
    def resource_id(self, resource_id):
        """Sets the resource_id of this TransitRouterMulticastDomainAssociationForDescribeTransitRouterMulticastDomainAssociationsOutput.
    ...
    def resource_type(self):
        """Gets the resource_type of this TransitRouterMulticastDomainAssociationForDescribeTransitRouterMulticastDomainAssociationsOutput.  # noqa: E501
    ...
    def resource_type(self, resource_type):
        """Sets the resource_type of this TransitRouterMulticastDomainAssociationForDescribeTransitRouterMulticastDomainAssociationsOutput.
    ...
    @property
    def status(self):
        """Gets the status of this TransitRouterMulticastDomainAssociationForDescribeTransitRouterMulticastDomainAssociationsOutput.  # noqa: E501
    ...
    def status(self, status):
        """Sets the status of this TransitRouterMulticastDomainAssociationForDescribeTransitRouterMulticastDomainAssociationsOutput.
    ...
    @property
    def subnet_id(self):
        """Gets the subnet_id of this TransitRouterMulticastDomainAssociationForDescribeTransitRouterMulticastDomainAssociationsOutput.  # noqa: E501
    ...
    def subnet_id(self, subnet_id):
        """Sets the subnet_id of this TransitRouterMulticastDomainAssociationForDescribeTransitRouterMulticastDomainAssociationsOutput.
    ...
    def transit_router_attachment_id(self):
        """Gets the transit_router_attachment_id of this TransitRouterMulticastDomainAssociationForDescribeTransitRouterMulticastDomainAssociationsOutput.  # noqa: E501
    ...
    def transit_router_attachment_id(self, transit_router_attachment_id):
        """Sets the transit_router_attachment_id of this TransitRouterMulticastDomainAssociationForDescribeTransitRouterMulticastDomainAssociationsOutput.
    ...
    def transit_router_multicast_domain_id(self):
        """Gets the transit_router_multicast_domain_id of this TransitRouterMulticastDomainAssociationForDescribeTransitRouterMulticastDomainAssociationsOutput.  # noqa: E501
    ...
    def transit_router_multicast_domain_id(self, transit_router_multicast_domain_id):
        """Sets the transit_router_multicast_domain_id of this TransitRouterMulticastDomainAssociationForDescribeTransitRouterMulticastDomainAssociationsOutput.
    ...
    def update_time(self):
        """Gets the update_time of this TransitRouterMulticastDomainAssociationForDescribeTransitRouterMulticastDomainAssociationsOutput.  # noqa: E501
    ...
    def update_time(self, update_time):
        """Sets the update_time of this TransitRouterMulticastDomainAssociationForDescribeTransitRouterMulticastDomainAssociationsOutput.
    ...
    def to_dict(self):
        ...
        for (attr, _) in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TransitRouterMulticastDomainAssociationForDescribeTransitRouterMulticastDomainAssociationsOutput, dict):
    ...
    def __eq__(self, other):
        ...
        if (not isinstance(other, TransitRouterMulticastDomainAssociationForDescribeTransitRouterMulticastDomainAssociationsOutput)):
            return False
...
class TransitRouterForwardPolicyEntryForDescribeTransitRouterForwardPolicyEntriesOutput(object, ):
    ...
    swagger_types = {'creation_time': 'str', 'description': 'str', 'destination_cidr_block': 'str', 'priority': 'int', 'source_cidr_block': 'str', 'status': 'str', 'transit_router_forward_policy_entry_id': 'str', 'transit_router_forward_policy_table_id': 'str', 'transit_router_route_table_id': 'str', 'update_time': 'str'}
    attribute_map = {'creation_time': 'CreationTime', 'description': 'Description', 'destination_cidr_block': 'DestinationCidrBlock', 'priority': 'Priority', 'source_cidr_block': 'SourceCidrBlock', 'status': 'Status', 'transit_router_forward_policy_entry_id': 'TransitRouterForwardPolicyEntryId', 'transit_router_forward_policy_table_id': 'TransitRouterForwardPolicyTableId', 'transit_router_route_table_id': 'TransitRouterRouteTableId', 'update_time': 'UpdateTime'}

    def __init__(self, creation_time=None, description=None, destination_cidr_block=None, priority=None, source_cidr_block=None, status=None, transit_router_forward_policy_entry_id=None, transit_router_forward_policy_table_id=None, transit_router_route_table_id=None, update_time=None, _configuration=None):
        'TransitRouterForwardPolicyEntryForDescribeTransitRouterForwardPolicyEntriesOutput - a model defined in Swagger'
        if (_configuration is None):
            _configuration = Configuration()
        self._configuration = _configuration
        self._creation_time = None
    ...
    def destination_cidr_block(self):
        """Gets the destination_cidr_block of this TransitRouterForwardPolicyEntryForDescribeTransitRouterForwardPolicyEntriesOutput.  # noqa: E501
    ...
    def destination_cidr_block(self, destination_cidr_block):
        """Sets the destination_cidr_block of this TransitRouterForwardPolicyEntryForDescribeTransitRouterForwardPolicyEntriesOutput.
...
class TransitRouterTrafficQosMarkingPolicyForDescribeTransitRouterTrafficQosMarkingPoliciesOutput(object, ):
    ...
    swagger_types = {'creation_time': 'str', 'description': 'str', 'status': 'str', 'transit_router_traffic_qos_marking_policy_id': 'str', 'transit_router_traffic_qos_marking_policy_name': 'str', 'update_time': 'str'}
    attribute_map = {'creation_time': 'CreationTime', 'description': 'Description', 'status': 'Status', 'transit_router_traffic_qos_marking_policy_id': 'TransitRouterTrafficQosMarkingPolicyId', 'transit_router_traffic_qos_marking_policy_name': 'TransitRouterTrafficQosMarkingPolicyName', 'update_time': 'UpdateTime'}

    def __init__(self, creation_time=None, description=None, status=None, transit_router_traffic_qos_marking_policy_id=None, transit_router_traffic_qos_marking_policy_name=None, update_time=None, _configuration=None):
        'TransitRouterTrafficQosMarkingPolicyForDescribeTransitRouterTrafficQosMarkingPoliciesOutput - a model defined in Swagger'
        if (_configuration is None):
            _configuration = Configuration()
        self._configuration = _configuration
        self._creation_time = None
    ...
    def to_dict(self):
        ...
        for (attr, _) in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TransitRouterTrafficQosMarkingPolicyForDescribeTransitRouterTrafficQosMarkingPoliciesOutput, dict):
            for (key, value) in self.items():
                result[key] = value
        return result
    ...
    def __eq__(self, other):
        'Returns true if both objects are equal'
        if (not isinstance(other, TransitRouterTrafficQosMarkingPolicyForDescribeTransitRouterTrafficQosMarkingPoliciesOutput)):
            return False
        return (self.to_dict() == other.to_dict())
...
class TransitRouterRoutePolicyEntryForDescribeTransitRouterRoutePolicyEntriesOutput(object, ):
    ...
    swagger_types = {'action_result': 'str', 'apply_as_path_values': 'list[int]', 'as_path_operate_mode': 'str', 'creation_time': 'str', 'description': 'str', 'destination_resource_ids': 'list[str]', 'destination_resource_types': 'list[str]', 'ip_prefix_match_mode': 'str', 'ip_prefixes': 'list[str]', 'prefix_list_id': 'str', 'priority': 'int', 'source_resource_ids': 'list[str]', 'source_resource_types': 'list[str]', 'status': 'str', 'transit_router_route_policy_entry_id': 'str', 'transit_router_route_policy_table_id': 'str', 'update_time': 'str'}
    attribute_map = {'action_result': 'ActionResult', 'apply_as_path_values': 'ApplyAsPathValues', 'as_path_operate_mode': 'AsPathOperateMode', 'creation_time': 'CreationTime', 'description': 'Description', 'destination_resource_ids': 'DestinationResourceIds', 'destination_resource_types': 'DestinationResourceTypes', 'ip_prefix_match_mode': 'IpPrefixMatchMode', 'ip_prefixes': 'IpPrefixes', 'prefix_list_id': 'PrefixListId', 'priority': 'Priority', 'source_resource_ids': 'SourceResourceIds', 'source_resource_types': 'SourceResourceTypes', 'status': 'Status', 'transit_router_route_policy_entry_id': 'TransitRouterRoutePolicyEntryId', 'transit_router_route_policy_table_id': 'TransitRouterRoutePolicyTableId', 'update_time': 'UpdateTime'}
    ...
    def __init__(self, action_result=None, apply_as_path_values=None, as_path_operate_mode=None, creation_time=None, description=None, destination_resource_ids=None, destination_resource_types=None, ip_prefix_match_mode=None, ip_prefixes=None, prefix_list_id=None, priority=None, source_resource_ids=None, source_resource_types=None, status=None, transit_router_route_policy_entry_id=None, transit_router_route_policy_table_id=None, update_time=None, _configuration=None):
        'TransitRouterRoutePolicyEntryForDescribeTransitRouterRoutePolicyEntriesOutput - a model defined in Swagger'
        if (_configuration is None):
            _configuration = Configuration()
        self._configuration = _configuration
    ...
    def ip_prefix_match_mode(self):
        """Gets the ip_prefix_match_mode of this TransitRouterRoutePolicyEntryForDescribeTransitRouterRoutePolicyEntriesOutput.  # noqa: E501
    ...
    def ip_prefix_match_mode(self, ip_prefix_match_mode):
        """Sets the ip_prefix_match_mode of this TransitRouterRoutePolicyEntryForDescribeTransitRouterRoutePolicyEntriesOutput.
    ...
    def prefix_list_id(self):
        """Gets the prefix_list_id of this TransitRouterRoutePolicyEntryForDescribeTransitRouterRoutePolicyEntriesOutput.  # noqa: E501


        :return: The prefix_list_id of this TransitRouterRoutePolicyEntryForDescribeTransitRouterRoutePolicyEntriesOutput.  # noqa: E501
        :rtype: str
        """
    ...
    def prefix_list_id(self, prefix_list_id):
        """Sets the prefix_list_id of this TransitRouterRoutePolicyEntryForDescribeTransitRouterRoutePolicyEntriesOutput.


        :param prefix_list_id: The prefix_list_id of this TransitRouterRoutePolicyEntryForDescribeTransitRouterRoutePolicyEntriesOutput.  # noqa: E501
        :type: str
        """
...
class TransitRouterForwardPolicyTableForDescribeTransitRouterForwardPolicyTablesOutput(object, ):
    ...
    swagger_types = {'creation_time': 'str', 'description': 'str', 'status': 'str', 'transit_router_forward_policy_table_id': 'str', 'transit_router_forward_policy_table_name': 'str', 'update_time': 'str'}
    attribute_map = {'creation_time': 'CreationTime', 'description': 'Description', 'status': 'Status', 'transit_router_forward_policy_table_id': 'TransitRouterForwardPolicyTableId', 'transit_router_forward_policy_table_name': 'TransitRouterForwardPolicyTableName', 'update_time': 'UpdateTime'}

    def __init__(self, creation_time=None, description=None, status=None, transit_router_forward_policy_table_id=None, transit_router_forward_policy_table_name=None, update_time=None, _configuration=None):
        'TransitRouterForwardPolicyTableForDescribeTransitRouterForwardPolicyTablesOutput - a model defined in Swagger'
        if (_configuration is None):
            _configuration = Configuration()
        self._configuration = _configuration
        self._creation_time = None
...
class TransitRouterRouteTablePropagationForDescribeTransitRouterRouteTablePropagationsOutput(object, ):
    ...
    swagger_types = {'creation_time': 'str', 'propagation_granularity': 'str', 'status': 'str', 'transit_router_attachment_id': 'str', 'transit_router_route_table_id': 'str'}
    attribute_map = {'creation_time': 'CreationTime', 'propagation_granularity': 'PropagationGranularity', 'status': 'Status', 'transit_router_attachment_id': 'TransitRouterAttachmentId', 'transit_router_route_table_id': 'TransitRouterRouteTableId'}

    def __init__(self, creation_time=None, propagation_granularity=None, status=None, transit_router_attachment_id=None, transit_router_route_table_id=None, _configuration=None):
        'TransitRouterRouteTablePropagationForDescribeTransitRouterRouteTablePropagationsOutput - a model defined in Swagger'
        if (_configuration is None):
            _configuration = Configuration()
        self._configuration = _configuration
        self._creation_time = None
    ...
    def propagation_granularity(self):
        """Gets the propagation_granularity of this TransitRouterRouteTablePropagationForDescribeTransitRouterRouteTablePropagationsOutput.  # noqa: E501


        :return: The propagation_granularity of this TransitRouterRouteTablePropagationForDescribeTransitRouterRouteTablePropagationsOutput.  # noqa: E501
        :rtype: str
        """
    ...
    def propagation_granularity(self, propagation_granularity):
        """Sets the propagation_granularity of this TransitRouterRouteTablePropagationForDescribeTransitRouterRouteTablePropagationsOutput.


        :param propagation_granularity: The propagation_granularity of this TransitRouterRouteTablePropagationForDescribeTransitRouterRouteTablePropagationsOutput.  # noqa: E501
        :type: str
        """
...
class TransitRouterTrafficQosMarkingEntryForDescribeTransitRouterTrafficQosMarkingEntriesOutput(object, ):
    ...
    swagger_types = {'creation_time': 'str', 'description': 'str', 'destination_cidr_block': 'str', 'destination_port_end': 'int', 'destination_port_start': 'int', 'match_dscp': 'int', 'priority': 'int', 'protocol': 'str', 'remarking_dscp': 'int', 'source_cidr_block': 'str', 'source_port_end': 'int', 'source_port_start': 'int', 'status': 'str', 'transit_router_traffic_qos_marking_entry_id': 'str', 'transit_router_traffic_qos_marking_entry_name': 'str', 'transit_router_traffic_qos_marking_policy_id': 'str', 'update_time': 'str'}
    attribute_map = {'creation_time': 'CreationTime', 'description': 'Description', 'destination_cidr_block': 'DestinationCidrBlock', 'destination_port_end': 'DestinationPortEnd', 'destination_port_start': 'DestinationPortStart', 'match_dscp': 'MatchDscp', 'priority': 'Priority', 'protocol': 'Protocol', 'remarking_dscp': 'RemarkingDscp', 'source_cidr_block': 'SourceCidrBlock', 'source_port_end': 'SourcePortEnd', 'source_port_start': 'SourcePortStart', 'status': 'Status', 'transit_router_traffic_qos_marking_entry_id': 'TransitRouterTrafficQosMarkingEntryId', 'transit_router_traffic_qos_marking_entry_name': 'TransitRouterTrafficQosMarkingEntryName', 'transit_router_traffic_qos_marking_policy_id': 'TransitRouterTrafficQosMarkingPolicyId', 'update_time': 'UpdateTime'}
    ...
    def __init__(self, creation_time=None, description=None, destination_cidr_block=None, destination_port_end=None, destination_port_start=None, match_dscp=None, priority=None, protocol=None, remarking_dscp=None, source_cidr_block=None, source_port_end=None, source_port_start=None, status=None, transit_router_traffic_qos_marking_entry_id=None, transit_router_traffic_qos_marking_entry_name=None, transit_router_traffic_qos_marking_policy_id=None, update_time=None, _configuration=None):
        'TransitRouterTrafficQosMarkingEntryForDescribeTransitRouterTrafficQosMarkingEntriesOutput - a model defined in Swagger'
        if (_configuration is None):
            _configuration = Configuration()
        self._configuration = _configuration
        self._creation_time = None
...
class TransitRouterTrafficQosQueuePolicyForDescribeTransitRouterTrafficQosQueuePoliciesOutput(object, ):
    ...
    swagger_types = {'creation_time': 'str', 'description': 'str', 'status': 'str', 'transit_router_traffic_qos_queue_policy_id': 'str', 'transit_router_traffic_qos_queue_policy_name': 'str', 'update_time': 'str'}
    attribute_map = {'creation_time': 'CreationTime', 'description': 'Description', 'status': 'Status', 'transit_router_traffic_qos_queue_policy_id': 'TransitRouterTrafficQosQueuePolicyId', 'transit_router_traffic_qos_queue_policy_name': 'TransitRouterTrafficQosQueuePolicyName', 'update_time': 'UpdateTime'}

    def __init__(self, creation_time=None, description=None, status=None, transit_router_traffic_qos_queue_policy_id=None, transit_router_traffic_qos_queue_policy_name=None, update_time=None, _configuration=None):
        'TransitRouterTrafficQosQueuePolicyForDescribeTransitRouterTrafficQosQueuePoliciesOutput - a model defined in Swagger'
        if (_configuration is None):
            _configuration = Configuration()
        self._configuration = _configuration
        self._creation_time = None
...
class TransitRouterRoutePolicyTableForDescribeTransitRouterRoutePolicyTablesOutput(object, ):
    ...
    swagger_types = {'creation_time': 'str', 'description': 'str', 'direction': 'str', 'status': 'str', 'transit_router_id': 'str', 'transit_router_route_policy_table_id': 'str', 'transit_router_route_policy_table_name': 'str', 'transit_router_route_table_ids': 'list[str]', 'update_time': 'str'}
    attribute_map = {'creation_time': 'CreationTime', 'description': 'Description', 'direction': 'Direction', 'status': 'Status', 'transit_router_id': 'TransitRouterId', 'transit_router_route_policy_table_id': 'TransitRouterRoutePolicyTableId', 'transit_router_route_policy_table_name': 'TransitRouterRoutePolicyTableName', 'transit_router_route_table_ids': 'TransitRouterRouteTableIds', 'update_time': 'UpdateTime'}

    def __init__(self, creation_time=None, description=None, direction=None, status=None, transit_router_id=None, transit_router_route_policy_table_id=None, transit_router_route_policy_table_name=None, transit_router_route_table_ids=None, update_time=None, _configuration=None):
        'TransitRouterRoutePolicyTableForDescribeTransitRouterRoutePolicyTablesOutput - a model defined in Swagger'
        if (_configuration is None):
            _configuration = Configuration()
        self._configuration = _configuration
        self._creation_time = None
...
class TransitRouterAttachmentForDescribeTransitRouterDirectConnectGatewayAttachmentsOutput(object, ):
    ...
    swagger_types = {'account_id': 'str', 'auto_publish_route_enabled': 'bool', 'bandwidth': 'int', 'creation_time': 'str', 'description': 'str', 'direct_connect_gateway_id': 'str', 'ipv6_enabled': 'bool', 'status': 'str', 'tags': 'list[TagForDescribeTransitRouterDirectConnectGatewayAttachmentsOutput]', 'transit_router_attachment_id': 'str', 'transit_router_attachment_name': 'str', 'transit_router_id': 'str', 'update_time': 'str'}
    attribute_map = {'account_id': 'AccountId', 'auto_publish_route_enabled': 'AutoPublishRouteEnabled', 'bandwidth': 'Bandwidth', 'creation_time': 'CreationTime', 'description': 'Description', 'direct_connect_gateway_id': 'DirectConnectGatewayId', 'ipv6_enabled': 'Ipv6Enabled', 'status': 'Status', 'tags': 'Tags', 'transit_router_attachment_id': 'TransitRouterAttachmentId', 'transit_router_attachment_name': 'TransitRouterAttachmentName', 'transit_router_id': 'TransitRouterId', 'update_time': 'UpdateTime'}

    def __init__(self, account_id=None, auto_publish_route_enabled=None, bandwidth=None, creation_time=None, description=None, direct_connect_gateway_id=None, ipv6_enabled=None, status=None, tags=None, transit_router_attachment_id=None, transit_router_attachment_name=None, transit_router_id=None, update_time=None, _configuration=None):
        'TransitRouterAttachmentForDescribeTransitRouterDirectConnectGatewayAttachmentsOutput - a model defined in Swagger'
        if (_configuration is None):
            _configuration = Configuration()
        self._configuration = _configuration
    ...
    @property
    def bandwidth(self):
        """Gets the bandwidth of this TransitRouterAttachmentForDescribeTransitRouterDirectConnectGatewayAttachmentsOutput.  # noqa: E501
    ...
    def bandwidth(self, bandwidth):
        """Sets the bandwidth of this TransitRouterAttachmentForDescribeTransitRouterDirectConnectGatewayAttachmentsOutput.
    ...
    def ipv6_enabled(self):
        """Gets the ipv6_enabled of this TransitRouterAttachmentForDescribeTransitRouterDirectConnectGatewayAttachmentsOutput.  # noqa: E501
    ...
    def ipv6_enabled(self, ipv6_enabled):
        """Sets the ipv6_enabled of this TransitRouterAttachmentForDescribeTransitRouterDirectConnectGatewayAttachmentsOutput.
...
class TransitRouterBandwidthPackageForDescribeTransitRouterBandwidthPackagesBillingOutput(object, ):
    ...
    swagger_types = {'billing_status': 'int', 'billing_type': 'int', 'expired_time': 'str', 'reclaim_time': 'str', 'remain_renew_times': 'int', 'renew_type': 'str', 'transit_router_bandwidth_package_id': 'str'}
    attribute_map = {'billing_status': 'BillingStatus', 'billing_type': 'BillingType', 'expired_time': 'ExpiredTime', 'reclaim_time': 'ReclaimTime', 'remain_renew_times': 'RemainRenewTimes', 'renew_type': 'RenewType', 'transit_router_bandwidth_package_id': 'TransitRouterBandwidthPackageId'}

    def __init__(self, billing_status=None, billing_type=None, expired_time=None, reclaim_time=None, remain_renew_times=None, renew_type=None, transit_router_bandwidth_package_id=None, _configuration=None):
        'TransitRouterBandwidthPackageForDescribeTransitRouterBandwidthPackagesBillingOutput - a model defined in Swagger'
        if (_configuration is None):
            _configuration = Configuration()
        self._configuration = _configuration
...
class TransitRouterTrafficQosQueueEntryForDescribeTransitRouterTrafficQosQueueEntriesOutput(object, ):
    ...
    swagger_types = {'bandwidth_percent': 'int', 'creation_time': 'str', 'description': 'str', 'dscps': 'list[int]', 'is_default': 'bool', 'priority': 'str', 'status': 'str', 'transit_router_traffic_qos_queue_entry_id': 'str', 'transit_router_traffic_qos_queue_entry_name': 'str', 'transit_router_traffic_qos_queue_policy_id': 'str', 'update_time': 'str'}
    attribute_map = {'bandwidth_percent': 'BandwidthPercent', 'creation_time': 'CreationTime', 'description': 'Description', 'dscps': 'Dscps', 'is_default': 'IsDefault', 'priority': 'Priority', 'status': 'Status', 'transit_router_traffic_qos_queue_entry_id': 'TransitRouterTrafficQosQueueEntryId', 'transit_router_traffic_qos_queue_entry_name': 'TransitRouterTrafficQosQueueEntryName', 'transit_router_traffic_qos_queue_policy_id': 'TransitRouterTrafficQosQueuePolicyId', 'update_time': 'UpdateTime'}

    def __init__(self, bandwidth_percent=None, creation_time=None, description=None, dscps=None, is_default=None, priority=None, status=None, transit_router_traffic_qos_queue_entry_id=None, transit_router_traffic_qos_queue_entry_name=None, transit_router_traffic_qos_queue_policy_id=None, update_time=None, _configuration=None):
        'TransitRouterTrafficQosQueueEntryForDescribeTransitRouterTrafficQosQueueEntriesOutput - a model defined in Swagger'
        if (_configuration is None):
            _configuration = Configuration()
        self._configuration = _configuration
    ...
    @property
    def priority(self):
        """Gets the priority of this TransitRouterTrafficQosQueueEntryForDescribeTransitRouterTrafficQosQueueEntriesOutput.  # noqa: E501


        :return: The priority of this TransitRouterTrafficQosQueueEntryForDescribeTransitRouterTrafficQosQueueEntriesOutput.  # noqa: E501
        :rtype: str
        """
    ...
    @priority.setter
    def priority(self, priority):
        """Sets the priority of this TransitRouterTrafficQosQueueEntryForDescribeTransitRouterTrafficQosQueueEntriesOutput.


        :param priority: The priority of this TransitRouterTrafficQosQueueEntryForDescribeTransitRouterTrafficQosQueueEntriesOutput.  # noqa: E501
        :type: str
        """
...
class TransitRouterRouteTableAssociationForDescribeTransitRouterRouteTableAssociationsOutput(object, ):
    ...
    swagger_types = {'status': 'str', 'transit_router_attachment_id': 'str', 'transit_router_route_table_id': 'str'}
    attribute_map = {'status': 'Status', 'transit_router_attachment_id': 'TransitRouterAttachmentId', 'transit_router_route_table_id': 'TransitRouterRouteTableId'}

    def __init__(self, status=None, transit_router_attachment_id=None, transit_router_route_table_id=None, _configuration=None):
        'TransitRouterRouteTableAssociationForDescribeTransitRouterRouteTableAssociationsOutput - a model defined in Swagger'
        if (_configuration is None):
            _configuration = Configuration()
        self._configuration = _configuration
        self._status = None
...
class TransitRouterBandwidthPackageForDescribeTransitRouterBandwidthPackagesOutput(object, ):
    ...
    swagger_types = {'account_id': 'str', 'allocations': 'list[AllocationForDescribeTransitRouterBandwidthPackagesOutput]', 'bandwidth': 'int', 'billing_type': 'int', 'business_status': 'str', 'creation_time': 'str', 'deleted_time': 'str', 'description': 'str', 'expired_time': 'str', 'line_operator': 'str', 'local_geographic_region_set_id': 'str', 'peer_geographic_region_set_id': 'str', 'project_name': 'str', 'remaining_bandwidth': 'int', 'status': 'str', 'tags': 'list[TagForDescribeTransitRouterBandwidthPackagesOutput]', 'transit_router_bandwidth_package_id': 'str', 'transit_router_bandwidth_package_name': 'str', 'update_time': 'str'}
    attribute_map = {'account_id': 'AccountId', 'allocations': 'Allocations', 'bandwidth': 'Bandwidth', 'billing_type': 'BillingType', 'business_status': 'BusinessStatus', 'creation_time': 'CreationTime', 'deleted_time': 'DeletedTime', 'description': 'Description', 'expired_time': 'ExpiredTime', 'line_operator': 'LineOperator', 'local_geographic_region_set_id': 'LocalGeographicRegionSetId', 'peer_geographic_region_set_id': 'PeerGeographicRegionSetId', 'project_name': 'ProjectName', 'remaining_bandwidth': 'RemainingBandwidth', 'status': 'Status', 'tags': 'Tags', 'transit_router_bandwidth_package_id': 'TransitRouterBandwidthPackageId', 'transit_router_bandwidth_package_name': 'TransitRouterBandwidthPackageName', 'update_time': 'UpdateTime'}

    def __init__(self, account_id=None, allocations=None, bandwidth=None, billing_type=None, business_status=None, creation_time=None, deleted_time=None, description=None, expired_time=None, line_operator=None, local_geographic_region_set_id=None, peer_geographic_region_set_id=None, project_name=None, remaining_bandwidth=None, status=None, tags=None, transit_router_bandwidth_package_id=None, transit_router_bandwidth_package_name=None, update_time=None, _configuration=None):
        'TransitRouterBandwidthPackageForDescribeTransitRouterBandwidthPackagesOutput - a model defined in Swagger'
        if (_configuration is None):
            _configuration = Configuration()
        self._configuration = _configuration
        self._account_id = None
    ...
    def line_operator(self):
        """Gets the line_operator of this TransitRouterBandwidthPackageForDescribeTransitRouterBandwidthPackagesOutput.  # noqa: E501
    ...
    def line_operator(self, line_operator):
        """Sets the line_operator of this TransitRouterBandwidthPackageForDescribeTransitRouterBandwidthPackagesOutput.
