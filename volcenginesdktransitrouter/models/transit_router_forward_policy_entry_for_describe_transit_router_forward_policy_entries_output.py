...
class TransitRouterForwardPolicyEntryForDescribeTransitRouterForwardPolicyEntriesOutput(object):
    ...
    def __init__(self, creation_time=None, description=None, priority=None, source_cidr_block=None, status=None, transit_router_forward_policy_entry_id=None, transit_router_forward_policy_table_id=None, transit_router_route_table_id=None, update_time=None, _configuration=None):  # noqa: E501
