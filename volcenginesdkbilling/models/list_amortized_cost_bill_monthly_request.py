...
class ListAmortizedCostBillMonthlyRequest(object):
    ...
    swagger_types = {
        ...
        'payer_id': 'list[int]',
        'product': 'list[str]',
        'tag_kv': 'list[TagKVForListAmortizedCostBillMonthlyInput]',
    ...
    def __init__(self, amortized_month=None, amortized_type=None, bill_category=None, bill_period=None, billing_mode=None, ignore_zero=None, instance_no=None, limit=None, need_record_num=None, offset=None, owner_id=None, payer_id=None, product=None, tag_kv=None, tag_kv_filter_mode=None, _configuration=None):  # noqa: E501
    ...
    @property
    def tag_kv(self):
        """Gets the tag_kv of this ListAmortizedCostBillMonthlyRequest.  # noqa: E501


        :return: The tag_kv of this ListAmortizedCostBillMonthlyRequest.  # noqa: E501
        :rtype: list[TagKVForListAmortizedCostBillMonthlyInput]
        """
        return self._tag_kv

    @tag_kv.setter
    def tag_kv(self, tag_kv):
        """Sets the tag_kv of this ListAmortizedCostBillMonthlyRequest.


        :param tag_kv: The tag_kv of this ListAmortizedCostBillMonthlyRequest.  # noqa: E501
        :type: list[TagKVForListAmortizedCostBillMonthlyInput]
        """
    ...
    def tag_kv_filter_mode(self):
        """Gets the tag_kv_filter_mode of this ListAmortizedCostBillMonthlyRequest.  # noqa: E501


        :return: The tag_kv_filter_mode of this ListAmortizedCostBillMonthlyRequest.  # noqa: E501
        :rtype: int
        """
    ...
    def tag_kv_filter_mode(self, tag_kv_filter_mode):
        """Sets the tag_kv_filter_mode of this ListAmortizedCostBillMonthlyRequest.


        :param tag_kv_filter_mode: The tag_kv_filter_mode of this ListAmortizedCostBillMonthlyRequest.  # noqa: E501
        :type: int
        """
