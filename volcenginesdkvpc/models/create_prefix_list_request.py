...
class CreatePrefixListRequest(object):
    ...
    def __init__(self, client_token=None, description=None, dry_run=None, ip_version=None, max_entries=None, prefix_list_entries=None, prefix_list_name=None, tags=None, _configuration=None):  # noqa: E501
