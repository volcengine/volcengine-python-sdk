...
class DescribeSubnetsRequest(object):
    ...
    def __init__(self, page_number=None, page_size=None, route_table_id=None, subnet_ids=None, subnet_name=None, vpc_id=None, zone_id=None, _configuration=None):  # noqa: E501
