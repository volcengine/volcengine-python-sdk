...
class ListTagsForResourcesRequest(object):
    ...
    def resource_type(self, resource_type):
        ...
        allowed_values = ["vpc", "eni", "securitygroup", "eip", "bandwidthpackage", "vpngateway", "ngw", "directconnectconnection", "directconnectgateway", "directconnectvirtualinterface"]  # noqa: E501
        if (self._configuration.client_side_validation and
