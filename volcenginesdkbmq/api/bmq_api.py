...
class BMQApi(object):
    ...
    def scale_down_instance(self, body, **kwargs):  # noqa: E501
        """scale_down_instance  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.scale_down_instance(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ScaleDownInstanceRequest body: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.scale_down_instance_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.scale_down_instance_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def scale_down_instance_with_http_info(self, body, **kwargs):  # noqa: E501
        """scale_down_instance  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.scale_down_instance_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method scale_down_instance" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `scale_down_instance`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/ScaleDownInstance/2023-06-01/bmq/post/application_json/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ScaleDownInstanceResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def topic_exist(self, body, **kwargs):  # noqa: E501
        """topic_exist  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.topic_exist(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param TopicExistRequest body: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.topic_exist_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.topic_exist_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def topic_exist_with_http_info(self, body, **kwargs):  # noqa: E501
        """topic_exist  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.topic_exist_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `topic_exist`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/TopicExist/2023-06-01/bmq/get/text_plain/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='TopicExistResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
