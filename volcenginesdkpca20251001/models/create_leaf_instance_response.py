...
class CreateLeafInstanceResponse(object):
    ...
    def __init__(self, certificate=None, chain=None, encryption_certificate=None, encryption_private_key=None, instance_id=None, parent_certificate=None, private_key=None, root_certificate=None, _configuration=None):  # noqa: E501
