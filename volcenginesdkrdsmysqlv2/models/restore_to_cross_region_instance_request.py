...
class RestoreToCrossRegionInstanceRequest(object):
    ...
    def __init__(self, allow_list_ids=None, backup_id=None, charge_info=None, db_param_group_id=None, dst_region_id=None, instance_name=None, instance_tags=None, node_info=None, project_name=None, restore_time=None, src_region_id=None, src_region_instance_id=None, storage_space=None, storage_type=None, subnet_id=None, vpc_id=None, _configuration=None):  # noqa: E501
        ...
        if src_region_instance_id is not None:
