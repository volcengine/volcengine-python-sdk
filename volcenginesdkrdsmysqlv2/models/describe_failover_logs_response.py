...
class DescribeFailoverLogsResponse(object):
    ...
    """
    swagger_types = {
        'datas': 'list[DataForDescribeFailoverLogsOutput]',
        'total': 'int'
    }
    ...
    @property
    def datas(self):
        """Gets the datas of this DescribeFailoverLogsResponse.  # noqa: E501


        :return: The datas of this DescribeFailoverLogsResponse.  # noqa: E501
        :rtype: list[DataForDescribeFailoverLogsOutput]
        """
        return self._datas

    @datas.setter
    def datas(self, datas):
        """Sets the datas of this DescribeFailoverLogsResponse.


        :param datas: The datas of this DescribeFailoverLogsResponse.  # noqa: E501
        :type: list[DataForDescribeFailoverLogsOutput]
        """
