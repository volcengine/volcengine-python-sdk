...
from volcenginesdkecs.models.scheduled_network_interfaces_open_res_for_describe_scheduled_instances_output import ScheduledNetworkInterfacesOpenResForDescribeScheduledInstancesOutput
