...
class SystemEventForDescribeSystemEventsOutput(object):
    ...
    def status(self, status):
        ...
        :type: str
        """
        allowed_values = ["UnknownStatus", "Executing", "Succeeded", "Failed", "Inquiring", "Scheduled"]  # noqa: E501
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["UnknownType", "SystemFailure_Stop", "SystemFailure_Reboot", "SystemFailure_PleaseCheck", "DiskError_Redeploy", "HDDBadSector_Redeploy", "GpuError_Redeploy", "SystemMaintenance_Redeploy", "SystemFailure_Redeploy", "CreateInstance", "RunInstance", "StopInstance", "DeleteInstance", "SpotInstanceInterruption_Delete", "AccountUnbalanced_Stop", "AccountUnbalanced_Delete", "InstanceChargeType_Change", "InstanceConfiguration_Change", "FileSystemReadOnly_Change"]  # noqa: E501
        if (self._configuration.client_side_validation and
