...
class DescribeDBAccountsResponse(object):
    ...
    """
    swagger_types = {
        'account': 'list[AccountForDescribeDBAccountsOutput]',
        'total': 'int'
    }
    ...
    def __init__(self, account=None, total=None, _configuration=None):  # noqa: E501
    ...
    @property
    def account(self):
        """Gets the account of this DescribeDBAccountsResponse.  # noqa: E501


        :return: The account of this DescribeDBAccountsResponse.  # noqa: E501
    ...
    def account(self, account):
        """Sets the account of this DescribeDBAccountsResponse.


        :param account: The account of this DescribeDBAccountsResponse.  # noqa: E501
