...
class DescribeCustomerGatewaysRequest(object):
    ...
    def __init__(self, customer_gateway_ids=None, customer_gateway_name=None, ip_address=None, page_number=None, page_size=None, status=None, _configuration=None):  # noqa: E501
