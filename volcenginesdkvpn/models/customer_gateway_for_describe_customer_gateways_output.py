...
class CustomerGatewayForDescribeCustomerGatewaysOutput(object):
    ...
    def __init__(self, account_id=None, connection_count=None, creation_time=None, customer_gateway_id=None, customer_gateway_name=None, description=None, ip_address=None, status=None, update_time=None, _configuration=None):  # noqa: E501
