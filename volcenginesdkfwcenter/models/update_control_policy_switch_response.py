...
class UpdateControlPolicySwitchResponse(object):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UpdateControlPolicySwitchResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateControlPolicySwitchResponse):
            return False
