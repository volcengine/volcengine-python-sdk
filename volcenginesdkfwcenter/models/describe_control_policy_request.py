...
class DescribeControlPolicyRequest(object):
    ...
    def __init__(self, action=None, destination=None, direction=None, page_number=None, page_size=None, proto=None, source=None, status=None, _configuration=None):  # noqa: E501
