...
class ConfCheckerForGetConfCheckerOutput(object):
    ...
    def __init__(self, bpm_id=None, conf_checker_python_script=None, description=None, id=None, modify_time=None, name=None, operator=None, psm=None, region=None, test_case=None, type=None, validator_version=None, _configuration=None):  # noqa: E501
        """ConfCheckerForGetConfCheckerOutput - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ConfCheckerForGetConfCheckerOutput, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConfCheckerForGetConfCheckerOutput):
            return False
