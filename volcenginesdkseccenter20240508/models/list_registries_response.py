...
class ListRegistriesResponse(object):
    ...
    """
    swagger_types = {
        'data': 'list[DataForListRegistriesOutput]',
        'page_number': 'int',
        'page_size': 'int',
        'total_count': 'int'
    }
    ...
    @property
    def data(self):
        """Gets the data of this ListRegistriesResponse.  # noqa: E501


        :return: The data of this ListRegistriesResponse.  # noqa: E501
        :rtype: list[DataForListRegistriesOutput]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this ListRegistriesResponse.


        :param data: The data of this ListRegistriesResponse.  # noqa: E501
        :type: list[DataForListRegistriesOutput]
        """
