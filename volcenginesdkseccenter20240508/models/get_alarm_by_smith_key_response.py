...
class GetAlarmBySmithKeyResponse(object):
    ...
    swagger_types = {
        ...
        'plus_alarm_info602x': 'PlusAlarmInfo602xForGetAlarmBySmithKeyOutput',
    ...
    def plus_alarm_info602x(self):
        """Gets the plus_alarm_info602x of this GetAlarmBySmithKeyResponse.  # noqa: E501


        :return: The plus_alarm_info602x of this GetAlarmBySmithKeyResponse.  # noqa: E501
        :rtype: PlusAlarmInfo602xForGetAlarmBySmithKeyOutput
        """
        return self._plus_alarm_info602x

    @plus_alarm_info602x.setter
    def plus_alarm_info602x(self, plus_alarm_info602x):
        """Sets the plus_alarm_info602x of this GetAlarmBySmithKeyResponse.


        :param plus_alarm_info602x: The plus_alarm_info602x of this GetAlarmBySmithKeyResponse.  # noqa: E501
