...
class GetRoleRequest(object):
    ...
    @property
    def role_name(self):
        """Gets the role_name of this GetRoleRequest.  # noqa: E501


        :return: The role_name of this GetRoleRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetRoleRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetRoleRequest):
            return False
