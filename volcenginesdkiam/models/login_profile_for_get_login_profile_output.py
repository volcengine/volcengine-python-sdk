...
class LoginProfileForGetLoginProfileOutput(object):
    ...
    @property
    def status(self):
        """Gets the status of this LoginProfileForGetLoginProfileOutput.  # noqa: E501


        :return: The status of this LoginProfileForGetLoginProfileOutput.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this LoginProfileForGetLoginProfileOutput.


        :param status: The status of this LoginProfileForGetLoginProfileOutput.  # noqa: E501
        :type: str
        """
