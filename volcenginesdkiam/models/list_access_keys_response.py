...
class ListAccessKeysResponse(object):
    ...
    def __init__(self, access_key_metadata=None, _configuration=None):  # noqa: E501
        """ListAccessKeysResponse - a model defined in Swagger"""  # noqa: E501
        if _configuration is None:
            _configuration = Configuration()
        self._configuration = _configuration

        self._access_key_metadata = None
        self.discriminator = None

        if access_key_metadata is not None:
            self.access_key_metadata = access_key_metadata

    @property
    def access_key_metadata(self):
        """Gets the access_key_metadata of this ListAccessKeysResponse.  # noqa: E501
    ...
    def access_key_metadata(self, access_key_metadata):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ListAccessKeysResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAccessKeysResponse):
            return False
