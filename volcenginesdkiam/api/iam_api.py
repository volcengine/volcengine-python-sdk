...
class IAMApi(object):
    ...
    def create_api_key_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/CreateApiKey/2018-01-01/iam/get/text_plain/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_api_key_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/DeleteApiKey/2018-01-01/iam/get/text_plain/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_service_linked_role_template(self, body, **kwargs):  # noqa: E501
        """get_service_linked_role_template  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_service_linked_role_template(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param GetServiceLinkedRoleTemplateRequest body: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_service_linked_role_template_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.get_service_linked_role_template_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def get_service_linked_role_template_with_http_info(self, body, **kwargs):  # noqa: E501
        """get_service_linked_role_template  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_service_linked_role_template_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_service_linked_role_template" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `get_service_linked_role_template`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/GetServiceLinkedRoleTemplate/2018-01-01/iam/get/text_plain/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='GetServiceLinkedRoleTemplateResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def list_api_keys_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/ListApiKeys/2018-01-01/iam/get/text_plain/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_api_key_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/UpdateApiKey/2018-01-01/iam/get/text_plain/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
