...
class PurchaseReservedStorageCapacityRequest(object):
    ...
    def __init__(self, client_token=None, period=None, period_unit=None, reserved_capacity=None, reserved_storage_capacity_name=None, volume_type=None, zone_id=None, _configuration=None):  # noqa: E501
