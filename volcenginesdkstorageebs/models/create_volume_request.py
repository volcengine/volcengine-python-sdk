...
class CreateVolumeRequest(object):
    ...
    def __init__(self, description=None, kind=None, size=None, volume_charge_type=None, volume_name=None, volume_type=None, zone_id=None, _configuration=None):  # noqa: E501
