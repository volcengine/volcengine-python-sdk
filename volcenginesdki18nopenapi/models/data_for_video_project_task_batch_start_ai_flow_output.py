...
class DataForVideoProjectTaskBatchStartAIFlowOutput(object):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DataForVideoProjectTaskBatchStartAIFlowOutput, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DataForVideoProjectTaskBatchStartAIFlowOutput):
            return False
