...
class ListServicesRequest(object):
    ...
    def __init__(self, create_time_after=None, create_time_before=None, name_contains=None, page_number=None, page_size=None, project_name=None, sort_by=None, sort_order=None, state=None, update_time_after=None, update_time_before=None, _configuration=None):  # noqa: E501
