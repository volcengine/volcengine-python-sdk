...
class UpdateDevInstanceRequest(object):
    ...
    def __init__(self, credential=None, description=None, id=None, name=None, node_affinity_spec=None, ports=None, resource_claim=None, resource_queue_id=None, ssh_public_key=None, storages=None, volume_size=None, _configuration=None):  # noqa: E501
