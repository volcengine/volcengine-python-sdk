...
class AddPhoneTemplateRequest(object):
    ...
    swagger_types = {
        'aosp_version': 'str',
        'overlay_persist_property': 'list[OverlayPersistPropertyForAddPhoneTemplateInput]',
        'overlay_property': 'list[OverlayPropertyForAddPhoneTemplateInput]',
        'overlay_settings': 'list[OverlaySettingForAddPhoneTemplateInput]',
    ...
    def __init__(self, aosp_version=None, overlay_persist_property=None, overlay_property=None, overlay_settings=None, phone_template_name=None, status=None, _configuration=None):  # noqa: E501
        """AddPhoneTemplateRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def aosp_version(self):
        """Gets the aosp_version of this AddPhoneTemplateRequest.  # noqa: E501
    ...
    def aosp_version(self, aosp_version):
        """Sets the aosp_version of this AddPhoneTemplateRequest.


        :param aosp_version: The aosp_version of this AddPhoneTemplateRequest.  # noqa: E501
        :type: str
        """
        if self._configuration.client_side_validation and aosp_version is None:
            raise ValueError("Invalid value for `aosp_version`, must not be `None`")  # noqa: E501

        self._aosp_version = aosp_version

    @property
    def overlay_persist_property(self):
        """Gets the overlay_persist_property of this AddPhoneTemplateRequest.  # noqa: E501
    ...
    def overlay_persist_property(self, overlay_persist_property):
        """Sets the overlay_persist_property of this AddPhoneTemplateRequest.
    ...
    def overlay_property(self):
        """Gets the overlay_property of this AddPhoneTemplateRequest.  # noqa: E501
    ...
    def overlay_property(self, overlay_property):
        """Sets the overlay_property of this AddPhoneTemplateRequest.
    ...
    def overlay_settings(self):
        """Gets the overlay_settings of this AddPhoneTemplateRequest.  # noqa: E501
    ...
    def overlay_settings(self, overlay_settings):
        """Sets the overlay_settings of this AddPhoneTemplateRequest.
    ...
    def phone_template_name(self):
        """Gets the phone_template_name of this AddPhoneTemplateRequest.  # noqa: E501
    ...
    def phone_template_name(self, phone_template_name):
        """Sets the phone_template_name of this AddPhoneTemplateRequest.


        :param phone_template_name: The phone_template_name of this AddPhoneTemplateRequest.  # noqa: E501
        :type: str
        """
        if self._configuration.client_side_validation and phone_template_name is None:
            raise ValueError("Invalid value for `phone_template_name`, must not be `None`")  # noqa: E501

        self._phone_template_name = phone_template_name

    @property
    def status(self):
        """Gets the status of this AddPhoneTemplateRequest.  # noqa: E501
    ...
    def status(self, status):
        """Sets the status of this AddPhoneTemplateRequest.
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AddPhoneTemplateRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddPhoneTemplateRequest):
            return False
