...
class DMSApi(object):
    ...
    def list_failed_objects(self, body, **kwargs):  # noqa: E501
        """list_failed_objects  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_failed_objects(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ListFailedObjectsRequest body: (required)
        :return: ListFailedObjectsResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_failed_objects_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.list_failed_objects_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def list_failed_objects_with_http_info(self, body, **kwargs):  # noqa: E501
        """list_failed_objects  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_failed_objects_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_failed_objects" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `list_failed_objects`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/ListFailedObjects/2018-01-01/dms/post/application_json/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ListFailedObjectsResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def retry_migrate_task_callback(self, body, **kwargs):  # noqa: E501
        """retry_migrate_task_callback  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.retry_migrate_task_callback(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param RetryMigrateTaskCallbackRequest body: (required)
        :return: RetryMigrateTaskCallbackResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.retry_migrate_task_callback_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.retry_migrate_task_callback_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def retry_migrate_task_callback_with_http_info(self, body, **kwargs):  # noqa: E501
        """retry_migrate_task_callback  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.retry_migrate_task_callback_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method retry_migrate_task_callback" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `retry_migrate_task_callback`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/RetryMigrateTaskCallback/2018-01-01/dms/post/application_json/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='RetryMigrateTaskCallbackResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
