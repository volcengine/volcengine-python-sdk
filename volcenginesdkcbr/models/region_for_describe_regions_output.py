...
class RegionForDescribeRegionsOutput(object):
    ...
    def __init__(self, name=None, region_id=None, _configuration=None):  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this RegionForDescribeRegionsOutput.  # noqa: E501


        :return: The name of this RegionForDescribeRegionsOutput.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this RegionForDescribeRegionsOutput.


        :param name: The name of this RegionForDescribeRegionsOutput.  # noqa: E501
        :type: str
        """
