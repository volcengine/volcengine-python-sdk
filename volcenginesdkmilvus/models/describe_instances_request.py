...
class DescribeInstancesRequest(object):
    ...
    def __init__(self, instance_id=None, instance_name=None, page_number=None, page_size=None, project_name=None, tag_filters=None, _configuration=None):  # noqa: E501
