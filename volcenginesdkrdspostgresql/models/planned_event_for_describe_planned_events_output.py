...
class PlannedEventForDescribePlannedEventsOutput(object):
    ...
    def __init__(self, business_impact=None, event_id=None, event_type=None, instance_id=None, instance_name=None, max_delay_time=None, planned_begin_time=None, planned_event_reason=None, planned_switch_begin_time=None, planned_switch_end_time=None, region=None, status=None, _configuration=None):  # noqa: E501
