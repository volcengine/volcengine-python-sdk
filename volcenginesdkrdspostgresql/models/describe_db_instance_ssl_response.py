...
class DescribeDBInstanceSSLResponse(object):
    ...
    def __init__(self, address=None, force_encryption=None, is_valid=None, ssl_enable=None, ssl_expire_time=None, tls_version=None, _configuration=None):  # noqa: E501
