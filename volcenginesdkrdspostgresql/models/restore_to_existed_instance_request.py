...
class RestoreToExistedInstanceRequest(object):
    ...
    swagger_types = {
        ...
        'target_db_instance_account': 'str',
    ...
    def __init__(self, backup_id=None, databases=None, source_db_instance_id=None, target_db_instance_account=None, target_db_instance_id=None, _configuration=None):  # noqa: E501
        ...
        self._target_db_instance_account = None
        ...
        self.target_db_instance_account = target_db_instance_account
    ...
    @property
    def target_db_instance_account(self):
        """Gets the target_db_instance_account of this RestoreToExistedInstanceRequest.  # noqa: E501


        :return: The target_db_instance_account of this RestoreToExistedInstanceRequest.  # noqa: E501
        :rtype: str
        """
        return self._target_db_instance_account

    @target_db_instance_account.setter
    def target_db_instance_account(self, target_db_instance_account):
        """Sets the target_db_instance_account of this RestoreToExistedInstanceRequest.


        :param target_db_instance_account: The target_db_instance_account of this RestoreToExistedInstanceRequest.  # noqa: E501
        :type: str
        """
        if self._configuration.client_side_validation and target_db_instance_account is None:
            raise ValueError("Invalid value for `target_db_instance_account`, must not be `None`")  # noqa: E501

        self._target_db_instance_account = target_db_instance_account
