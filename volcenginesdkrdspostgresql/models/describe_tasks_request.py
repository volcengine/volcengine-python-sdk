...
class DescribeTasksRequest(object):
    ...
    def __init__(self, creation_end_time=None, creation_start_time=None, instance_id=None, page_number=None, page_size=None, project_name=None, task_action=None, task_id=None, task_status=None, _configuration=None):  # noqa: E501
