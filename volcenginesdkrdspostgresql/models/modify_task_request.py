...
class ModifyTaskRequest(object):
    ...
    def __init__(self, instance_id=None, modify_begin_time=None, modify_end_time=None, project_name=None, task_event_operation=None, task_id=None, _configuration=None):  # noqa: E501
