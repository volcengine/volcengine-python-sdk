...
class ListLoadBalancerResponse(object):
    ...
    def __init__(self, data=None, _configuration=None):  # noqa: E501
        """ListLoadBalancerResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this ListLoadBalancerResponse.  # noqa: E501
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this ListLoadBalancerResponse.
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ListLoadBalancerResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListLoadBalancerResponse):
            return False
